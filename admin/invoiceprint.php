...
$type_of_bed = $type_of_bed_rate * $type_of_room / 100;
...
$type_of_meal = $type_of_meal_rate * $type_of_room / 100;
	...
	<header>
		...
		<span><img alt="" src="../img/logo.jpg"></span>
	</header>
	<article>
		<h1>Recipient</h1>
		<address>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- inbox.rohanm@gmail.com || Web :- www.hotelblissful.com || Phone :- +91 88377xxxxx </p>
		</div>
	</aside>
