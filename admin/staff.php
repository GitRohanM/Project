...
<head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" type="x-icon" href="..s/img/logo.png">
...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            ...
            <button type="submit" class="btn btn-success" name="addstaff">Add Worker</button>
        </form>
